...
const Works = () => {
  return (
    <>
      ...
      >
        <p className={styles.sectionSubText}>Naše Práce</p>
      ...
      <div className='w-full flex'>
        ...
        >
          Tyto projektu ukazují naše dovednosti a zkušenosti v našem oboru.
          každý projekt je jedinečný a má svůj vlastní příběh.
          Reflektují naše schopnosti a zkušenosti v oblasti vývoje, designu, důmyslnosti a kreativity.
